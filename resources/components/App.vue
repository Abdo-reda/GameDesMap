<template>
    <div class="absolute -z-50 inset-0 bg-[url(/resources/assets/svgs/grid_0.svg)] bg-center [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))]">
    </div>

    <div>
        <h1 class="text-3xl font-bold underline"> Main App </h1>

        <nav class="p-6 m-4 max-w-fit bg-white rounded-xl shadow-lg flex items-center divide-x divide-gray-300/50">
            <ul>
            ...
            <div class="mx-auto max-w-md">
                <div class="divide-y divide-gray-300/50">
                    <div class="space-y-6 py-8 text-base leading-7 text-gray-600">
                        <p>Trying random stuff out</p>
                    </div>
                    <div class="pt-8 text-base font-semibold leading-7">
                        <p class="text-gray-900">What is going on ???</p>
                        <p>
...
<script>
  ...
  export default {
    // Your Vue application logic goes here
  }
</script>